...
prop_sliding_window=0.2
masked_lm_prob=0.15
dupe_factor=10
dim=16
signature="-sw${prop_sliding_window}-mlp${masked_lm_prob}-df${dupe_factor}-mppq${max_predictions_per_seq}-msl${max_seq_length}"
batch_size=256
num_train_steps=200000
# signature="s0.1-m0.15-d10-mm20-ms200"
